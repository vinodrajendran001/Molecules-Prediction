...
from breze.learn.mlp_pcn import Mlp, FastDropoutNetwork
...
typ = 'fd'
if typ == 'plain':
    m = Mlp(X.shape[1], [40, 30, 10], 1, X, Z,
            hidden_transfers=['rectifier', 'rectifier', 'rectifier'], out_transfer='identity', loss='squared', optimizer=optimizer, batch_size=batch_size, max_iter=max_iter)
elif typ == 'fd':
    m = FastDropoutNetwork(X.shape[1], [800,800], 1, X, Z,
