...
datafile = '/home/vinod/Downloads/MLPonTheano/backup/autoencoder/best_qm7bob/CAE/autoencoder1.pkl'
...
optimizer = 'gd', {'step_rate': 0.001, 'momentum': 0.9}
...
if typ == 'plain':
    ...
    m = FastDropoutNetwork(X.shape[1], [30,10], 1, X, Z,
...
ax.plot(losses)
fig.savefig('automlp_loss.png', bbox_inches='tight')
